...
data.frame(base = as.numeric(base_dist), full = as.numeric(full_dist)) %>% 
  ggplot()+
    geom_histogram(aes(base), fill = 'blue', alpha = 0.5)+
    geom_histogram(aes(full), fill = 'red', alpha = 0.5)
```
...
SVF <- stars::read_stars("../data_preparation/SVF/SVF_3035.tif")
